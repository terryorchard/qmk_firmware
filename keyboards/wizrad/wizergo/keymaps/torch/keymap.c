...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(             // 0
    ...
    LT(2,KC_Z),	  KC_X,				  KC_C,				  KC_V,				  KC_B,				      KC_N,				  KC_M,				  KC_COMM,			KC_DOT,			  LT(_NUMPAD,KC_SLSH),
                  LCTL_T(KC_TAB),LT(1,KC_BSPC),LT(4,KC_DEL),TO(_NUMPAD),      KC_MPLY,			LT(4,KC_ENT),	LT(2,KC_SPC),	LT(1,KC_ESC)
  ),
  [_FUNSYM] = LAYOUT(           // 1
    ...
    KC_F1,			  KC_F12,       KC_PIPE,			DM_PLY2,      DM_PLY1,	        KC_TILD,			KC_UNDS,			KC_PLUS,			KC_LBRC,			KC_RBRC,
                  TO(_BASE),    KC_TRNS,			TO(5),			  KC_TRNS,          KC_TRNS,      CW_TOGG,			MO(3),			  KC_TRNS
  ),
  [_NUMNAV] = LAYOUT(           // 2
    ...
    KC_LSFT,			KC_LBRC,			KC_RBRC,			KC_PGDN,			KC_END,			      KC_GRV,			  KC_MINS,			KC_EQL,			  KC_COLN,			KC_SCLN,
                  KC_TRNS,			MO(3),			  CW_TOGG,			KC_TRNS,          KC_TRNS,      TO(5),			  KC_TRNS,			TO(_BASE)
  ),
  [_ADJUST] = LAYOUT(           // 3
