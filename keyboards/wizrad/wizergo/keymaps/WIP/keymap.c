...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(             // 0
    ...
    LT(2,KC_Z),	  KC_X,				  KC_C,				  KC_V,				  KC_B,				      KC_N,				  KC_M,				  KC_COMM,			KC_DOT,			  LT(_NUMPAD,KC_SLSH),
                LGUI_T(KC_TAB),LSFT_T(KC_BSPC),LT(1,KC_DEL),TO(_NUMPAD),      KC_MPLY,			LT(2,KC_ENT),RSFT_T(KC_SPC),RGUI_T(KC_ESC)
  ),
  [_LOWER] = LAYOUT(           // 1
    ...
    KC_F1,			  KC_F12,       KC_PIPE,			DM_PLY2,      DM_PLY1,	        KC_TILD,			KC_UNDS,			KC_PLUS,			KC_LBRC,			KC_RBRC,
                  TO(_BASE),    TO(_GAMING),  KC_TRNS,			KC_TRNS,          KC_TRNS,      MO(_ADJUST),  CW_TOGG,			KC_TRNS
  ),
  [_RAISE] = LAYOUT(           // 2
    ...
    KC_LSFT,			KC_LBRC,			KC_RBRC,			KC_PGDN,			KC_END,			      KC_GRV,			  KC_MINS,			KC_EQL,			  KC_COLN,			KC_SCLN,
                  KC_TRNS,			CW_TOGG,			MO(_ADJUST),  KC_TRNS,          KC_TRNS,      KC_TRNS,			TO(_GAMING),  TO(_BASE)
  ),
  [_ADJUST] = LAYOUT(           // 3
    ...
    KC_SLEP,			KC_F19,			  KC_F20,			  KC_F21,			  LCA(KC_L),		    LCA(KC_L),		KC_NO,			  KC_NO,			  KC_NO,			  KC_NO,
